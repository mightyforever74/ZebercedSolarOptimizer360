...
# Nginx'in yöneteceği başlıklar (backend'te set ETME)
...
@app.after_request
def unify_security_headers(resp):
    for h in NGINX_SECURITY_HEADERS:
...
def root():
    return jsonify(status="ok", service="SolarOptimizer360 API"), 200
